module SymbolTable.SemanticAnalyzerLiteralTest where

import Test.Hspec
import SymbolTable.SemanticAnalyzerLiteral (processLiteral)
...
testProcessLiteral :: Spec
testProcessLiteral = describe "processLiteral" $ do
